...
BitmapMemoryManager::BitmapMemoryManager() : alloc_map_{}, range_begin_{0}, range_end_{FrameID{kFrameCount}} {
};
...
// BIOSからのmemory mapを用いて、OSのmemory managerを初期化
