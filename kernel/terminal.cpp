...
void Terminal::ExecuteLine() {
    ...
    if (strcmp(command, "echo") == 0) {
        ...
        auto entries_per_cluster = (fat::boot_volume_image->bytes_per_sector * fat::boot_volume_image->sectors_per_cluster) / sizeof(fat::DirectoryEntry);
        char base[9], ext[4];
        char s[64];
